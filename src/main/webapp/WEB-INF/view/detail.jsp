      ...
      <input type="hidden" name="id" value="${donation.id}">
        <div class="col-lg-6">
          ...
          <div class="pt-5">
            ...
            <ul class="comment-list" style=" max-height: 240px;overflow-y: scroll;">
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form action="${pageContext.request.contextPath}/user/saveUserDonation" method="post" modelAttribute="userDonation">
            <div class="modal-body">
              <div class="row">
                <div class="col-12"> 
                  ...
                  <input type="hidden" value="${donation.id}" class="form-control" placeholder="" id="addname" name="donation" required> 
